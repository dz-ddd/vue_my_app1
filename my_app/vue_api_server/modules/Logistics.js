...
function autoComNumber(orderno) {
  const url = `https://poll.kuaidi100.com/poll/query.do?customer==${orderno}`
...
async function getLogisticsInfo(req, res) {
  ...
  const dataUrl = `https://www.kuaidi100.com/query?type=${result.comCode}&postid=${req.params.orderno}&temp=0.95247267684455`
